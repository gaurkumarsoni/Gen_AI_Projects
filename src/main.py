...
st.title("🈯 Translator App GPT-4o-mini")

col1, col2 = st.columns(2)

with col1:
    input_languages_list = ["English", "French", "German", "Latin", "Spanish", "Hindi", "Tamil", "Telugu"]
...
input_text = st.text_area("Type the text here to be translated.")
